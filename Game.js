...
"use strict";
    ...
    var gameScore = document.getElementById("skur");
    var totalScore = 0;
    var autoMove = false;
    ...
    if(h > w){
        document.getElementById("main").style.transform = "translateX("+(w)+"px) rotate(90deg)";
        document.getElementById("main").style.width = h+"px";
        var nh = h;
        h = w;
        w = nh;
    ...
    Arrow.prototype.drawArrow = function() {
        if(this.vis) {
            ...
            try{
                            ...
                            document.getElementById("skur").innerHTML = 0;
